 ...
 */
@OnlyIn(Dist.CLIENT)
public class FactoryIOInserterBlockEntityRenderer implements BlockEntityRenderer<FactoryIOInserterBlockEntity> {

    /** Taille de l'item transporté, en fraction d'un bloc. */
    private static final float ITEM_SCALE = 0.4F;

    private final GeoBlockRenderer<FactoryIOInserterBlockEntity> geometry;
    ...
    @Override
    public void render(FactoryIOInserterBlockEntity inserter, float partialTick, PoseStack poseStack,
    ...
    @Override
    public boolean shouldRenderOffScreen(FactoryIOInserterBlockEntity inserter) {
     ...
     */
    private static int lightAt(FactoryIOInserterBlockEntity inserter, Vec3 localPosition) {
    ...
    private static final class Geometry extends GeoBlockRenderer<FactoryIOInserterBlockEntity> {
